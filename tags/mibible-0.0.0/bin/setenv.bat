...
goto end
:doneLib
set CLASSPATH=%MIBBLE_HOME%\lib\mibble-parser-2.8.jar;%MIBBLE_HOME%\lib\mibble-mibs-2.8.jar;%MIBBLE_HOME%\lib\grammatica-bin-1.4.jar;%MIBBLE_HOME%\lib\snmp4_13.jar
